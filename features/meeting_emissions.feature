Feature: Meeting Emissions Calculations
  ...
  Scenario: Calculations starting from duration, area, and zip code
    ...
    When impacts are calculated
    Then the amount of "carbon" should be within "0.1" kgs of "10.21"
